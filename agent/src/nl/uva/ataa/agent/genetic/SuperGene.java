...
public class SuperGene extends BaseGene implements Gene, java.io.Serializable {
	 ...
	 * instances. The new instance that is created and returned should be setup
	 * with any implementation-dependent configuration that this Gene instance
	 * is setup with (aside from the actual value, of course). For example, if
	 * this Gene were setup with bounds on its value, then the Gene instance
	 * returned from this method should also be setup with those same bounds.
	 * This is important, as the JGAP core will invoke this method on each Gene
	 * in the sample Chromosome in order to create each new Gene in the same
	 * respective gene position for a new Chromosome.
	 * 
	 * It should be noted that nothing is guaranteed about the actual value of
	 * the returned Gene and it should therefore be considered to be undefined.
	 * 
	...
	/**
	 * Sets the value of this Gene to the new given value. The actual type of
	...
	/**
	 * Retrieves the value represented by this Gene. The actual type of the
	 ...
	 *            The random number generator that should be used to create any
	 *            random values. It's important to use this generator to
	 *            maintain the user's flexibility to configure the genetic
	...
	/**
	 * Retrieves a string representation of the value of this Gene instance that
	 * includes any information required to reconstruct it at a later time, such
	 * as its value and internal state. This string will be used to represent
	 * this Gene instance in XML persistence. This is an optional method but, if
	...
	/**
	 * Executed by the genetic engine when this Gene instance is no longer
	 * needed and should perform any necessary resource cleanup.
	 */
	@Override
	public void cleanup() {
	 ...
	 * 
	 * @return true if this QuarterGene is equal to the given QuarterGene, false
	 *         otherwise.
	 */
	@Override
