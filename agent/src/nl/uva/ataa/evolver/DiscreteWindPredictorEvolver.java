...
public class DiscreteWindPredictorEvolver extends Evolver<DiscreteWindPredictor> {
    ...
    private static final double MUTATION_RANGE = 0.4;
     ...
     */
    public DiscreteWindPredictorEvolver(final int poolSize, final FitnessFunction fitnessFunction) {
    ...
    @Override
    protected DiscreteWindPredictor getSpecimen(final Conf conf) {
        return new DiscreteWindPredictor((FitnessFunction) conf.get("ff"));
    }
