...
public class WindGene extends BaseGene implements Gene, java.io.Serializable {
     ...
     */
    public WindGene(final Configuration a_conf) throws InvalidConfigurationException {
        super(a_conf);
    }
    ...
    public int compareTo(final Object a_otherQuarterGene) {
        ...
        return mGeneValue.compareTo(((WindGene) a_otherQuarterGene).mGeneValue);
    }
    ...
    public boolean equals(final Object otherQuarterGene) {
        return otherQuarterGene instanceof WindGene && compareTo(otherQuarterGene) == 0;
    }
